  ...
  <body>
    ...
    <section id="home" class="hero">
      <div class="hero-content">
        ...
        <p>Your destination for fresh fruits and vegetables</p>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            <div class="about-image">
              <img
                src="https://c4.wallpaperflare.com/wallpaper/437/455/804/food-fruit-strawberries-blood-orange-wallpaper-preview.jpg"
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="contact-info">
              <p>
                <i class="fas fa-map-marker-alt"></i> 123 Fresh Street, City, Country
              </p>
